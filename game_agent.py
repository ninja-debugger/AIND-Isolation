...
def custom_score(game, player):
    ...
    opp_moves = len(game.get_legal_moves(
        game.get_opponent(player))) / len(game.get_blank_spaces())
...
def custom_score_2(game, player):
    ...
    # Oponents moves weigh more than ours.
    own_moves = len(game.get_legal_moves(player))
...
def custom_score_3(game, player):
    ...
    # Oppenents weight is greater than ours
    own_moves = len(game.get_legal_moves(player))
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **************  YOU DO NOT NEED TO MODIFY THIS FUNCTION  *************
        ...
        # Initialize the best move to get
        # a move in case the search fails due to timeout
        best_move = (-1, -1)
